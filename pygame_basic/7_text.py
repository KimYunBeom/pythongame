...
# 배경 이미지 불러오기
background = pygame.image.load('C:/data/dev/workspace3/pythongame/pygame_basic/background.png')

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load('C:/data/dev/workspace3/pythongame/pygame_basic/character.png')
...
# 적 enemy 캐릭터
enemy = pygame.image.load('C:/data/dev/workspace3/pythongame/pygame_basic/enemy.png')
